...
const DashboardHeader = ({ farmer, loading }) => {
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div>
            ...
            <p className="text-gray-600 flex items-center gap-2">
              <span>🏠</span>
              {farmer?.farmName} • {farmer?.location?.city || 'Your Farm'}
            </p>
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-3 bg-gray-50 hover:bg-gray-100 rounded-lg px-4 py-2 transition-colors border"
            >
